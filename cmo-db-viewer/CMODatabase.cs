...
namespace cmo_db_viewer
{
    internal class CMODatabase
    {
        ...
        public static List<(string Name, Type DataType)> DataTables = new List<(string Name, Type DataType)>()
        {
            ...
            ("EnumShipType", typeof(EnumShipType)),
            ("EnumShipPhysicalSize", typeof(EnumShipPhysicalSize)),
            ("EnumShipCSGen", typeof(EnumShipCSGen)),
            ("DataMount", typeof(DataMount)),
            ("DataShip", typeof(DataShip)),
            ("DataShipMounts", typeof(DataShipMounts)),
            ("DataMountWeapons", typeof(DataMountWeapons)),
            ("EnumAircraftFacilityType", typeof(EnumAircraftFacilityType)),
            ("DataAircraftFacility", typeof(DataAircraftFacility)),
            ("DataShipAircraftFacilities", typeof(DataShipAircraftFacilities))
        };
        ...
        internal static void ReadDescriptions(string descriptionFolder)
        {
            string[] files = Directory.GetFiles(descriptionFolder, "*.txt");
            ...
            foreach (string file in files)
            {
                ...
                {
                    (DataAircraft.DataEntries[id] as DataAircraft).Description = File.ReadAllText(file);
                }
            }
        }
    }
